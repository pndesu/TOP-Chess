            ...
            if piece.instance_of?(Pawn) || piece.instance_of?(Knight)
                ...
                if piece.position[0] == king.position[0]
                    ...
                    if piece.position[1] < king.position[1]
                        ...
                        (0..king.position[0] - 1 - piece.position[0]).each{|i| in_check_squares << Board.board[piece.position[0] + i][piece.position[1]]}
                    end
                else
                    if piece.position[1] < king.position[1]
                        (0..king.position[1] - 1 - piece.position[1]).each{|i| in_check_squares << Board.board[piece.position[0] - i][piece.position[1] + i]}
                        ...
                        (0..piece.position[0] - 1 - king.position[0]).each{|i| in_check_squares << Board.board[piece.position[0] - i][piece.position[1]]}
                    end
                end
            end
        end
